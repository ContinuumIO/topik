...
from topik.visualizers import data_formatters
...
def test_top_words():
    top_words = data_formatters.get_top_words(vectorizer_output, topic_term_matrix, TOP_WORDS)
...
def test_termite_pandas_output():
    data = data_formatters.termite_data(vectorizer_output, topic_term_matrix, topn=TOP_WORDS)
